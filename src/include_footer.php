...
<footer class="" id='page_footer'>
    <div class="footer_wrapper py-4">
        <div class="container">
            <div class="row mb-3">
                <div class="text-center text-dark">

                    <img class="mb-2 footer_logo" src="src/img/favicon/logo.svg" alt="footer logo" style="height:30px; filter: filter: contrast(10%);">
                    <div class="fw-bold text-uppercase fs-6">
                        <a class="text-body text-decoration-none" href="<?php echo $siteInfo->rootUrl; ?>">
...
<script src="src/js/main.js?v=4908"></script>
<?php
