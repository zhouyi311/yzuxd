...
usort($projects, function ($a, $b) {
    if ($a->indexOrder === $b->indexOrder) {
        return 0; // Maintain the original order if both elements have the same value
    }
...
<body class="">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <nav class="page_navbar home_navbar navbar fixed-top px-4" id="page_navbar">
                    ...
                    <!-- nav btn -->
                    <button class="navbar-toggler nav_listen_target" type="button" data-bs-toggle="offcanvas"
    ...
    <!-- Main -->
    <main id="home_main" data-bs-spy="scroll" data-bs-target="#navbar_target" data-bs-root-margin="0px 0px -40%"
                        ...
                        <div class="hero_card px-4 py-4 px-md-0 py-md-0 rounded-5">
                            ...
                            <div class="col-12">
                                <h2 class="text-white display-4 mt-3">
                                    <?php echo htmlspecialchars($site_info->fontPageContent["heroGreetings"]); ?>
                                </h2>
                                <h1 class="text-white text_hero">
                                    <?php echo $site_info->fontPageContent["heroHeadline"]; ?>
                                </h1>
                            </div>
                            <div class='col-md-7 col-lg-5'>
                                <div class="text-light">
                                    <p class="lead text-light">
                                        <?php echo htmlspecialchars($site_info->fontPageContent["heroIntroduction"]); ?>
                                    </p>
                                </div>
                                <div class="text-light fw-light">
                                    <?php echo ($site_info->fontPageContent["heroSummaryHtml"]); ?>
                                </div>
                                <div class="call_to_action_group mb-4 mt-5">
                                    <a class="hero_btn btn btn-dark btn-lg border-0 rounded-pill px-4 fw-light"
                                        href="#projects">
                                        <?php echo htmlspecialchars($site_info->fontPageContent["heroCallToAction"]); ?>
                ...
                <div class="hero_decoration_container">
                    ...
                    <div class="extra_wrapper">
                        <div class="container-xxl">
                            <div class="row">
                                <div
                                    class="col-12 col-md-7 offset-md-5 col-lg-8 offset-lg-4 col-xl-8 offset-xl-4 bg_positioner none_select">
                                    <div class="dec_bg">
                                    </div>
                                    <div class="dec_items">
                                        <div id="hero_moveable">
                                            <div class="hero_self_tilting">
                                                <div class="hero_tilting_group">
                                                    <img class="hero_decoration ztrans_0"
            ...
            <div class="container" id="projects_container">
                <div class="row gy-4 gy-lg-5 gx-xl-5">
                    ...
                    function createProjectCard($project, $isFeatured)
                    {
                        ...
                        $summary = htmlspecialchars($project->summary['text']);
                        if ($isFeatured) {
                        ...
                        echo "<div class='summary_content fw-light'>$summary</div>";
                        echo "</div><div class='card_info_cta mt-1 mb-2'>";
        ...
        <section class="page_section" id="contact">
            ...
            <div class="container">
                <div class="row gy-5">
                        ...
                        <div class="contact_card rounded-5 text-dark p-5 shadow-lg-5">
                            ...
                            <form id="contactForm" class="contact_form my-5 text-dark fw-medium">
                                <div class="form-floating mb-2 fw-light">
                                    <input id="msg_submit_email"
                                        class="form-control border-2 rounded-4 border-secondary fw-light" type="email"
                                        name="fromEmail" placeholder="Your email" required>
                                    <label class="floatingInput border-0 bg-transparent" for="msg_submit_email">Your
                                        Email</label>
                                </div>
                                <div class="form-floating fw-light">
                                    <textarea id="msg_submit_content"
                                        class="form-control border-2 rounded-4 border-secondary fw-light" name="message"
                                        placeholder="Your message" style="height: 6rem" required></textarea>
                            ...
                            <div class="contact_sheet text-nowrap">
                                ...
                                <h4>EMAIL</h4>
                                <div class="mb-4">
                                    <a class="text-dark link-offset-3 text-decoration-none"
                                        href="mailto:<?php echo htmlspecialchars($site_info->information['myEmail']); ?>">
                                ...
                                <div class="d-flex gap-4 mb-3">
                                    <div>
                                        <a class="text-dark link-offset-3" target="_blank"
                    ...
                    <div class="col-lg-5">
                        <div
                            class="contact_dec_flex_wrap h-100 d-flex flex-column justify-content-center align-items-center">
